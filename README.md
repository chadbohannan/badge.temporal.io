...
| [`firmware/`](firmware/) | PlatformIO firmware project for the ESP32-S3 badge, including native C++ screens, MicroPython embedding, OTA, and the badge filesystem source. | [`firmware/README.md`](firmware/README.md) |
...
- `replay2026-factory-16MB.bin`: complete factory image with bootloader,
  partition table, firmware, and FAT filesystem.
...
files use the MIT License unless a file or notice says otherwise; see
[`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md) and [`licenses/`](licenses/)
for the carve-outs that remain.
